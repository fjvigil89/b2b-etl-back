...
const CIAL_TESTING = {
  DB: "b2b-app-cial",
  PASSWORD: env.B2B_CIAL_TESTING_PASSWORD,
  PORT_DB: Number(env.B2B_CIAL_TESTING_PORT),
  SERVER: env.B2B_CIAL_TESTING_SERVER,
  USER_DB: env.B2B_CIAL_TESTING_USERNAME,
};
